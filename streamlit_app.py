...
#         st.write(f"Citation information exported to {csv_output_path}.")
#         # Display a link to download the generated files
#         if os.path.exists(output_path):
#             st.markdown(f"[Download the generated citation map]({output_path})")
#         if os.path.exists(csv_output_path):
#             st.markdown(f"[Download the generated CSV file]({csv_output_path})")
#     else:
